...
import com.prunny.project.broker.KafkaConsumer;
...
public class ProjectKafkaResource {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(ProjectKafkaResource.class);
    private final KafkaConsumer kafkaConsumer;
    private final StreamBridge streamBridge;

    public ProjectKafkaResource(StreamBridge streamBridge, KafkaConsumer kafkaConsumer) {
