package com.prunny.gateway.config;

import static org.springframework.security.config.Customizer.withDefaults;
import static org.springframework.security.web.server.util.matcher.ServerWebExchangeMatchers.pathMatchers;

import com.prunny.gateway.security.AuthoritiesConstants;
import com.prunny.gateway.web.filter.SpaWebFilter;
...
public class SecurityConfiguration {
    ...
    public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http) {
        http
            ...
            .securityContextRepository(NoOpServerSecurityContextRepository.getInstance()); // Don't use Spring Security context
...
//                    .pathMatchers("/services/authservice/api/auth/register").permitAll()
//                    .pathMatchers("/services/authservice/api/auth/login").permitAll()
//                    .pathMatchers("/services/authservice/api/auth/validate").permitAll()
